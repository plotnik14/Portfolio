# Проекты
[PLANET RIDER](#planet-rider)  
[ЭРЕБОС](#эребос)  
[PIRATE ADVENTURE](#pirate-adventure)  

# PLANET RIDER  
Гиперкежуал гонка на выживание. В рамках проекта реализовано следующее:  
* Настройка и интеграция Zenject для использования преимуществ DI/IoC.
* Обновление интерфейса с использованием свойств UniRX.
* Логика притяжения машины и остальных предметов к планете.
* Управление машиной с помощью Input System.
* Сборка под Android.  
...
2D платформер про девочку из магической академии. Игра создана командой из 8 человек и является призером [XYZ Game Jam](https://itch.io/jam/xyz-game-jam-0/results). Как единственный программист в команде, я в рамках проекта реализовал следующее:  
